...
exports.CREATE = `\
INSERT INTO operations (user_id, product_id, count, operation_type_id, store_id, creation_datetime) \
VALUES (?, ?, ?, ?, ?, NOW())\
`;
...
LEFT JOIN stores AS storesTable \
...
DELETE operations FROM operations \
LEFT JOIN operation_types as operationTypesTable \
